...
import styles from './OrgUserMng.less';
...
@Form.create()
export default class OrgUserMng extends SimpleMng {
    constructor() {
        super();
                ...
                <Row gutter={{ md: 6, lg: 24, xl: 48 }}>
                    <Col md={16} sm={24} >
                        <Button
                            icon="plus"
                            type="primary"
                            onClick={() => this.showEditForm({ editFormRecord: { isOrgAdd: true }, editForm: 'userRegForm', editFormTitle: '添加新用户' })}
                        >
                            添加
                        </Button>
