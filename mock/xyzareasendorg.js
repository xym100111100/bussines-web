...
export function xyzareasendorgList(req, res) {
  res.json(tableListDataSource);
}

export function xyzareasendorgGetById(req, res, u) {
  let url = u;
...
export function xyzareasendorgAdd(req, res, u, b) {
...
export function xyzareasendorgModify(req, res, u, b) {
  const body = (b && b.body) || req.body;
...
export function xyzareasendorgDel(req, res, u) {
  let url = u;
  if (!url || Object.prototype.toString.call(url) !== '[object String]') {
    url = req.url; // eslint-disable-line
  }
