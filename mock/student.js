...
export function studentList(req, res) {
  res.json(tableListDataSource);
}

export function studentGetById(req, res, u) {
  let url = u;
...
export function studentAdd(req, res, u, b) {
...
export function studentModify(req, res, u, b) {
  const body = (b && b.body) || req.body;
...
export function studentDel(req, res, u) {
  let url = u;
  if (!url || Object.prototype.toString.call(url) !== '[object String]') {
    url = req.url; // eslint-disable-line
  }
