...
export function dumaiindexList(req, res) {
  res.json(tableListDataSource);
}

export function dumaiindexGetById(req, res, u) {
  let url = u;
...
export function dumaiindexAdd(req, res, u, b) {
...
export function dumaiindexModify(req, res, u, b) {
  const body = (b && b.body) || req.body;
...
export function dumaiindexDel(req, res, u) {
  let url = u;
  if (!url || Object.prototype.toString.call(url) !== '[object String]') {
    url = req.url; // eslint-disable-line
  }
