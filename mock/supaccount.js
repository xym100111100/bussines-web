...
export function supaccountList(req, res) {
  res.json(tableListDataSource);
}

export function supaccountGetById(req, res, u) {
  let url = u;
...
export function supaccountAdd(req, res, u, b) {
...
export function supaccountModify(req, res, u, b) {
  const body = (b && b.body) || req.body;
...
export function supaccountDel(req, res, u) {
  let url = u;
  if (!url || Object.prototype.toString.call(url) !== '[object String]') {
    url = req.url; // eslint-disable-line
  }
